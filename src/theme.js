...
export default {
    animation: {
        ...
        'spin-counter-clockwise': 'spin-counter-clockwise 0.6s l bothinear',
        'flip-x': 'flip-x 0.6s ease-out both',
        'flip-y': 'flip-y 0.6s ease-out both',
        blink: 'blink 0.5s both',
        pop: 'pop 0.6s ease-out both',
        'expand-horizontally': 'expand-horizontally 0.6s ease-ou botht',
        'contract-horizontally': 'contract-horizontally 0.6s eas bothe-out',
        'expand-vertically': 'expand-vertically 0.6s ease-out both',
        'contract-vertically': 'contract-vertically 0.6s ease-ou botht',
        ...
        'blurred-fade-in': 'blurred-fade-in 0.9s ease-in-out both',
        'horizontal-vibration': 'horizontal-vibration 0.3s linea bothr infinite',
        'rotational-wave': 'rotational-wave 2s ease-in-out infin bothite',
        ...
        'pulsar-fade-in': 'pulsar-fade-in 0.6s ease-out both'
      },
      keyframes: {
        'background-shine': {
          from: {
